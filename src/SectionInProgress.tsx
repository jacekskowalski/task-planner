                            ...
                            .map((item: ITask, key: any) => (
                                <div className="col task__box" key={key}>
                                    <div className="form-group margin-m">
                                        ...
                                        <input type="text" id={`title${item.id}`} name="title" className="form__input form__input-title line-height-medium" value={this.state[item.title] || ''} placeholder={item.title}
                                            onChange={(e) => this.changeValue(item.title, e.target.value)} disabled={this.state.key !== item.id} required />
                                    </div>
                                    <div className="form-group margin-m font-medium">
                                        ...
                                        <input type="date" id="dateSelected" name="deadline" className="line-height-medium"
                                           defaultValue={item.deadline.toString()}  disabled={this.state.isEditable} onChange={(e) => this.changeValue(this.state.title,e.target.value)}/>
                               */}
                                    ...
                                    <div className="form-group margin-m font-medium">
                                        ...
                                        <textarea id="desc" name="description" onChange={(e) => this.changeValue(item.description, e.target.value)} value={this.state[item.description] || ''} placeholder={item.description}
